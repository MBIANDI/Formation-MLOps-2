...
def predict_endpoint():
    ...
    predict_df = predict(features, model_path= "20200616-140746.joblib")
    #pred = features['predictions'][0]
    # print("**********************", file=sys.stderr)
    # print(pred, file=sys.stderr){'users': df.to_dict()}
    return jsonify(predict_df.to_json())
